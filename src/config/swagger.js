...
const swaggerDefinition = {
  ...
  components: {
    securitySchemes: {
      BearerAuth: {  // Định nghĩa Security scheme cho Bearer token
        type: 'http',
        scheme: 'bearer',
        bearerFormat: 'JWT',
      },
...
const options = {
  ...
  explorer: true,
  // apis: ['../routes/*.js'],
  apis: [path.join(__dirname, '../routes/*.js'), path.join(__dirname, '../routes/v1/*.js')], // Đường dẫn đến các file chứa JSDoc comments
