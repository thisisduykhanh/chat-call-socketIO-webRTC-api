...
module.exports = (app, server) => {
    ...
    io.on("connection", async (socket) => {
                ...
                if (stillExists) {
                    ...
                    try {
                        const message = {
                            ...
                            sender_id: userId,
                            content: `Missed call (${formatDuration(
                                duration
                            )})`,
        ...
        socket.on("call-offer", ({ toUserId, offer }) => {
            ...
            console.log(`Sent call-offer from ${userId} to ${toUserId}: ${JSON.stringify(offer)}`);
        ...
        socket.on("call-answer", ({ toUserId, answer }) => {
            ...
            console.log(`Sent call-answer from ${userId} to ${toUserId}: ${JSON.stringify(answer)}`); 
        ...
        socket.on("ice-candidate", ({ toUserId, candidate }) => {
            ...
            console.log(`Sent ICE candidate from ${userId} to ${toUserId}: ${JSON.stringify(candidate)}`);
                        ...
                        if (remainingParticipants === 0) {
                            ...
                            try {
                                const message = {
                                    ...
                                    conversation_id: conversationId,
                                    sender_id: userId,
                                    content: `Voice call ended (${formatDuration(
                                        duration
                                    )})`,
                                    timestamp: endTime.getTime(),
                                    status: "sent",
