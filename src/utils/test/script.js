...
async function joinConversation() {
  ...
  socket.emit('join-conversation', { conversationId: currentConversationId, userId: currentUserId });
}
...
function acceptCall() {
  ...
  socket.emit('accept-call', { conversationId: currentConversationId, toUserId: initiatorId });
}
